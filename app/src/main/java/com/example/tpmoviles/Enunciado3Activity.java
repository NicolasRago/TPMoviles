...
public class Enunciado3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    Enunciado3Activity.StartCountTask task;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_enunciado_3);
